...
class ModelUserUserGroup extends Model {
	...
	public function getUserGroupByUserId($user_id, $select = "*") {
	    return $this->db->query("select " . $select ." from user_group g inner join user u on g.user_group_id = u.user_group_id where u.user_id = ". (int)$user_id) -> row;
	}
}