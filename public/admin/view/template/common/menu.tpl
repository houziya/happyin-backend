<ul id="menu">
	<?php if(in_array($user_group_name, ["hangzhou", "shandong"])) { ?>
	<li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      <li><a href="<?php echo $hz_order; ?>"><?php echo $text_hz_order; ?></a></li>
      <li><a href="<?php echo $hz_processing; ?>"><?php echo $text_processing; ?></a></li>
    </ul>
  </li>
	<?php } else { ?>
    ...
    <ul>
      ...
      <li><a href="<?php echo $print; ?>"><?php echo $text_print; ?></a></li>
      <li><a href="<?php echo $parts_management; ?>"><?php echo $text_parts_management; ?></a></li>
 ...
 <!-- <li id="catalog"><a class="parent"><i class="fa fa-plane fa-fw"></i> <span><?php echo $text_express; ?></span></a>
    <ul>
      <li><a href="<?php echo $shipment; ?>"><?php echo $text_shipment; ?></a></li>
    </ul>
  </li> --!>
 ...
 <li><a href="<?php echo $order_recurring; ?>"><?php echo $text_order_recurring; ?></a></li>
  ...
  <li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      <li><a href="<?php echo $order; ?>"><?php echo $text_order; ?></a></li>
      <li><a href="<?php echo $hz_order; ?>"><?php echo "杭州订单管理"; ?></a></li>
      <li><a href="<?php echo $hz_order_processing; ?>"><?php echo "杭州打单发货"; ?></a></li>
      <li><a href="<?php echo $sd_order; ?>"><?php echo "山东订单管理"; ?></a></li>
      <li><a href="<?php echo $sd_order_processing; ?>"><?php echo "山东打单发货"; ?></a></li>
    </ul>
  </li>
  ...
  <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_parent; ?></span></a>
    <ul>
      <!-- <li><a class="parent"><?php echo $text_sale; ?></a>
       ...
       <li id="cost"><a class="parent"> <span><?php echo $text_cost; ?></span></a>
            <ul>--!>
                <li><a href="<?php echo $cost_price; ?>"><?php echo $text_cost_price; ?></a></li>
                <li><a href="<?php echo $shipment; ?>"><?php echo $text_shipment; ?></a></li>
                <li><a href="<?php echo $cost_accounting; ?>"><?php echo $text_cost_accounting; ?></a></li>
                <li><a href="<?php echo $cost_accounting_sd; ?>"><?php echo $text_cost_accounting_sd; ?></a></li>
                <li><a href="<?php echo $cost_accounting_zj; ?>"><?php echo $text_cost_accounting_zj; ?></a></li>
          <!-- </ul>
      </li> --!>
  ...
  <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_reports; ?></span></a>
  	<ul>
      <li><a href="<?php echo $statistic_sale; ?>"><?php echo $text_statistic_sale; ?></a></li>
      <li><a href="<?php echo $statistic_channel; ?>"><?php echo $text_statistic_channel; ?></a></li>
<!--<li><a href="<?php echo $statistic_cost_accounting; ?>"><?php echo $text_statistic_cost_accounting; ?></a></li>-->
      <li><a href="<?php echo $statistic_coupon; ?>"><?php echo $text_statistic_coupon; ?></a></li>
    </ul>
  </li>
  ...
  <!-- <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_parts; ?></span></a>
  	<ul>
      <li><a href="<?php echo $parts_management; ?>"><?php echo $text_parts_management; ?></a></li>
    </ul>
  </li> --!>
   ...
   <!--   <li><a class="parent"><?php echo $text_localisation; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $stock_warning; ?>"><?php echo $text_stock_warning; ?></a></li>
