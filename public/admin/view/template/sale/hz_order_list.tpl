  ...
  <div class="page-header">
    <div class="container-fluid">
      ...
      <button type="submit" id="button-excel" form="form-order" formaction="<?php echo $action;?>" data-toggle="tooltip" title="" class="btn btn-info">导出收货人</button>
        <button type="submit" id="button-parcel" form="form-order" formaction="/admin/index.php?route=sale/hz_order/parcleComboAction&token=<?php echo $token;?>" data-toggle="tooltip" title="" class="btn btn-info">下载照片</button>
        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-shipping-firstname"><?php echo $entry_shipping_firstname; ?></label>
                <input type="text" name="filter_shipping_firstname" value="<?php echo $filter_shipping_firstname; ?>" placeholder="<?php echo $entry_shipping_firstname; ?>" id="input-shipping-firstname" class="form-control" />
              </div>
            </div>
            <div class="col-sm-4">
              <!--<div class="form-group">
              ...
              <div class="form-group">
                <label class="control-label" for="input-total"><?php echo $entry_order_number; ?></label>
                <input type="text" name="filter_order_number" value="<?php echo $filter_order_number; ?>" placeholder="<?php echo $entry_order_number; ?>" id="input-order-number" class="form-control" />
              </div>
              <div class="form-group">
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr data-toggle="popover" class="<?php echo $order['status'] == "新订单" ? "info" : "";?>">
                  ...
                  <td class="text-left"><?php echo $order['shipping_firstname']; ?></td>
                  <td class="text-left col-md-2 inline">
                  <div class="">
                     <span class="input-group-btn">
                     <select class="btn btn-default" name="splitting_company" id="input-meta-keyword2">
					...
					<?php } ?>
                     ...
                     <input readonly class="btn btn-default" id="shipping_id" name="shipping_id" value="<?php echo $order['shipping_id']; ?>" type="text" placeholder="快递单号">
                     ...
                     <?php }else{ ?>
                     <input class="btn btn-default" id="shipping_id" name="shipping_id" value="<?php echo $order['shipping_id']; ?>" type="text" placeholder="快递单号">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=sale/hz_order&token=<?php echo $token; ?>&splitting_code=<?php echo $splitting_code;?>';
