        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-total"><?php echo $entry_shipping_firstname; ?></label>
                <input type="text" name="filter_shipping_firstname" value="<?php echo $filter_shipping_firstname; ?>" placeholder="<?php echo $entry_shipping_firstname; ?>" id="input-total" class="form-control" />
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
