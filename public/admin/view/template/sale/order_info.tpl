    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <!--<td class="text-left">优惠券</td>
              <td class="text-left">抵扣金额</td>-->
          ...
          <tbody>
            ...
            <tr>
              ...
              <!--<td class="text-left"><?php echo $product['coupon_name']; ?></td>
              <td class="text-left"><?php echo $product['coupon_price']; ?></td>-->
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              <td style="width: 50%;" class="text-left">优惠券</td>
              <td style="width: 50%;" class="text-left">优惠金额</td>
            </tr>
          </thead>
          <tbody>
            <?php foreach($coupon as $couponInfo) { ?>
            <tr>  
              <td class="text-left"><?php echo $couponInfo['name']; ?></td>
              <td class="text-left"><?php echo $couponInfo['value']; ?></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
        <div class="row">
	        ...
	        <div class="col-md-2">
	           运费:<?php echo (int)$product['pay_total'] > Order::$freeShipping ? "￥0.00" : "￥".Order::$postage; ?> (满<?php echo Order::$freeShipping; ?>包邮)
	        </div>
        </div>
        <div class="row">
	        <div class="col-md-4">
...
// Login to the API
$.ajax({
	url: 'http://<?php echo $store_url; ?>/catalog/index.php?route=api/login',
	type: 'post',
	dataType: 'json',
