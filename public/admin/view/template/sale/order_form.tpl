...
// Login to the API
$.ajax({
	url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/login',
	type: 'post',
...
$('select[name=\'currency\']').on('change', function() {
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/currency&token=' + token,
		type: 'post',
...
$('#button-refresh').on('click', function() {
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/cart/products&token=' + token,
		dataType: 'json',
		crossDomain: true,
		success: function(json) {
...
$('#button-customer').on('click', function() {
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/customer&token=' + token,
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
                ...
                var request_1 = $.ajax({
                    url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/cart/add&token=' + token,
                    type: 'post',
                ...
                var request_2 = request_1.then(function() {
                    $.ajax({
                        url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/voucher/add&token=' + token,
                        type: 'post',
...
$('#cart').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/cart/remove&token=' + token,
		type: 'post',
...
$('#button-payment-address').on('click', function() {
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/payment/address&token=' + token,
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Payment Methods
				$.ajax({
					url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/payment/methods&token=' + token,
					dataType: 'json',
					crossDomain: true,
					beforeSend: function() {
...
$('#button-shipping-address').on('click', function() {
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/shipping/address&token=' + token,
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Shipping Methods
				var request = $.ajax({
					url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/shipping/methods&token=' + token,
					dataType: 'json',
					beforeSend: function() {
...
$('#button-shipping-method').on('click', function() {
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/shipping/method&token=' + token,
		type: 'post',
...
$('#button-payment-method').on('click', function() {
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/payment/method&token=' + token,
		type: 'post',
...
$('#button-coupon').on('click', function() {
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/coupon&token=' + token,
		type: 'post',
...
$('#button-voucher').on('click', function() {
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/voucher&token=' + token,
		type: 'post',
...
$('#button-reward').on('click', function() {
	$.ajax({
		url: $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/reward&token=' + token,
		type: 'post',
...
$('#button-save').on('click', function() {
	if ($('input[name=\'order_id\']').val() == 0) {
		var url = $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/order/add&token=' + token;
	} else {
		var url = $('select[name=\'store\'] option:selected').val() + 'catalog/index.php?route=api/order/edit&token=' + token + '&order_id=' + $('input[name=\'order_id\']').val();
	}
