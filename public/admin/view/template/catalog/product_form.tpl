          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" width="200px" height="150px"/></a>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity"><?php echo $entry_quantity_sd; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="quantity_sd" value="<?php echo $quantity_sd; ?>" placeholder="<?php echo $entry_quantity_sd; ?>" id="input-quantity" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity"><?php echo $entry_quantity_zj; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="quantity_zj" value="<?php echo $quantity_zj; ?>" placeholder="<?php echo $entry_quantity_zj; ?>" id="input-quantity" class="form-control" />
                </div>
              </div>
              ...
              <!--规格解释-->
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sort-order"><?php echo $entry_standard_explain; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="standard_explain" value="<?php echo $standard_explain; ?>" placeholder="<?php echo $entry_standard_explain; ?>" id="input-sort-order" class="form-control" />
                </div>
              </div>
            </div>
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-parentproduct"><span data-toggle="tooltip" title="<?php echo "选择父商品"; ?>"><?php echo "选择父商品"; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="parent_product" value="" placeholder="<?php echo "选择父商品"; ?>" id="input-parentproduct" class="form-control" />
                  <div id="product-parent" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_parent as $product_extend) { ?>
                    <div id="product-parent<?php echo $product_extend['parent_product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_extend['model']; ?>
                      <input type="hidden" name="product_parent[]" value="<?php echo $product_extend['parent_product_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      <td class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $product_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" weight="100px" height="100px" /></a>
                          <input type="hidden" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image['images']; ?>" id="input-image<?php echo $image_row; ?>" /></td>
...
$('input[name=\'parent_product\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/product/ajaxGetList&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
	...
	'select': function(item) {
		...
		$('#product-parent' + item['value']).remove();

		$('#product-parent').append('<div id="product-parent' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product_parent[]" value="' + item['value'] + '" /></div>');
	}
});
...
$('#product-parent').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
