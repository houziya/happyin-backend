...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
		    ...
		    $productName = "";
		    array_walk($products, function (&$value, $key) use (&$productName) {
			...
			$data['orders'][] = array(
			    ...
			    'shipping_address'        => "省:". $result['shipping_country'] . " 市:". $result['shipping_city'] . " 区:". $result['shipping_zone'] . " <br/>". $result['shipping_address_1'],
	...
	public function info() {
		...
		if ($order_info) {
            ...
            $data['coupon'] = Coupon::getOrderCoupon($this->request->get['order_id']);
