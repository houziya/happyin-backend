...
class ControllerCommonStats extends Controller {
	public function index() {
		...
		$complete_total = $this->model_sale_order->getTotalOrders(array('filter_order_status' => implode(',', Order::$configCompleteStatus)));
		...
		$processing_total = $this->model_sale_order->getTotalOrders(array('filter_order_status' => implode(',', Order::$configProcessingStatus)));
		...
		foreach ($results as $result) {
			if (!in_array($result['order_status_id'], array_merge(Order::$configProcessingStatus, Order::$configCompleteStatus))) {
