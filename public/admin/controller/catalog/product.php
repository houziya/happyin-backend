...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$image = HI\Config\QCloud\IMAGE\DOMAIN . "/admin/images/" . $result['image'] . ".jpg";
			$special = false;
        ...
        //库存预警值
		$data['stockWarning'] = $this->model_catalog_product->getWarningProductNum();
	...
	protected function getForm() {
		...
		$data['entry_quantity'] = $this->language->get('entry_quantity');
		$data['entry_quantity_sd'] = $this->language->get('entry_quantity_sd');
		$data['entry_quantity_zj'] = $this->language->get('entry_quantity_zj');
		...
		$data['entry_standard_explain'] = $this->language->get('entry_standard_explain');
		...
		if (isset($this->request->post['image']) && is_file(DIR_IMAGE . $this->request->post['image'])) {
		    ...
		    $data['thumb'] = HI\Config\QCloud\IMAGE\DOMAIN . "/admin/images/" . $product_info['image'] . ".jpg";
		} else {
		...
		if (isset($this->request->post['quantity_sd'])) {
		    $data['quantity_sd'] = $this->request->post['quantity_sd'];
		} elseif (!empty($product_info)) {
		    $data['quantity_sd'] = $product_info['quantity_sd'];
		} else {
		    $data['quantity_sd'] = 1;
		}
		
		if (isset($this->request->post['quantity_zj'])) {
		    $data['quantity_zj'] = $this->request->post['quantity_zj'];
		} elseif (!empty($product_info)) {
		    $data['quantity_zj'] = $product_info['quantity_zj'];
		} else {
		    $data['quantity_zj'] = 1;
		}
		...
		if (isset($this->request->post['standard_explain'])) {
		    $data['standard_explain'] = $this->request->post['standard_explain'];
		} elseif (!empty($product_info)) {
		    $data['standard_explain'] = $product_info['standard_explain'];
		} else {
		    $data['standard_explain'] = '';
		}
		...
		$data['product_parent'] = $this->model_catalog_product->getProductParent($data['isbn']);
		...
		foreach ($product_images as $product_image) {
			if ($product_image['image']) {
				$image = HI\Config\QCloud\IMAGE\DOMAIN . "/admin/images/".$product_image['image'].'.jpg';
			    $thumb = HI\Config\QCloud\IMAGE\DOMAIN . "/admin/images/".$product_image['image'].'.jpg';
			} else {
				$image = '';
				$thumb = 'no_image.png';
			}
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])) {
            ...
            if (isset($this->request->get['type'])) {
                $results = $this->model_catalog_product->getProducts($filter_data, 1);
            } else {
                $results = $this->model_catalog_product->getProducts($filter_data);
            }
			foreach ($results as $result) {
