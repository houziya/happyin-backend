...
class CChannel{
    const OFFSET=3;
    private static $channel_table_name = HI\TableName\SPREAD_CHANNEL_STAT;
    private static $main_table_name = HI\TableName\SPREAD_MAIN_CHANNEL;
    private static $sub_table_name = HI\TableName\SPREAD_SUB_CHANNEL;
