...
class Preconditions
{
    ...
    public static function checkArray($array, $message = null) {
        if (Predicates::isNotArray($array)) {
            throw new InvalidArgumentException(Accessor::either($message, "Argument '" . json_encode($array) . " is not an array"));
        }
        return $array;
    }
}
